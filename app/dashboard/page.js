...
export default function Dashboard() {
  ...
  const businessId = 'd919f037-d91d-4981-91d2-c4bc7443004e'
  const slug = 'testbiz'
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#050810', fontFamily: "'Inter', sans-serif", color: 'white' }}>
      ...
      <nav style={{ borderBottom: '1px solid #111', padding: '0 5%', height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(5,8,16,0.9)', backdropFilter: 'blur(12px)', position: 'sticky', top: 0, zIndex: 100 }}>
        ...
        <a href={`/collect/${slug}`} target="_blank" style={{ background: 'rgba(37,99,235,0.15)', border: '1px solid rgba(37,99,235,0.3)', color: '#60a5fa', padding: '8px 16px', borderRadius: 8, fontSize: 13, fontWeight: 600, textDecoration: 'none', transition: 'all 0.2s' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '40px 5%' }}>
        ...
        <div className="header-row" style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 40 }}>
          <div>
            <h1 style={{ fontSize: 32, fontWeight: 800, letterSpacing: '-1px', marginBottom: 6 }}>Your Reviews</h1>
            <p style={{ color: '#555', fontSize: 15 }}>Manage and approve customer testimonials</p>
          </div>
          <div style={{ background: '#0d1117', border: '1px solid #1a2030', borderRadius: 12, padding: '10px 18px', display: 'flex', alignItems: 'center', gap: 10 }}>
            <span style={{ color: '#666', fontSize: 13 }}>Collection link:</span>
            <code style={{ color: '#60a5fa', fontSize: 13 }}>trustdrop-lac.vercel.app/collect/{slug}</code>
          </div>
        </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 16 }}>
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 14 }}>
                      ...
                      <span style={{ marginLeft: 'auto', padding: '4px 12px', borderRadius: 100, fontSize: 12, fontWeight: 600, background: t.approved ? 'rgba(52,211,153,0.1)' : 'rgba(245,158,11,0.1)', color: t.approved ? '#34d399' : '#f59e0b', border: `1px solid ${t.approved ? 'rgba(52,211,153,0.3)' : 'rgba(245,158,11,0.3)'}` }}>
