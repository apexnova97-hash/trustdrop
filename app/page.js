    ...
    <main style={{ fontFamily: "'Inter', sans-serif", background: '#050810', minHeight: '100vh', color: 'white', overflowX: 'hidden' }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .cta-btn { display: inline-block; background: linear-gradient(135deg, #2563eb, #1d4ed8); color: white; padding: 14px 32px; border-radius: 10px; font-size: 16px; font-weight: 600; text-decoration: none; cursor: pointer; border: none; transition: all 0.2s; font-family: inherit; box-shadow: 0 0 30px rgba(37,99,235,0.4); }
        .cta-btn:hover { transform: translateY(-2px); box-shadow: 0 0 50px rgba(37,99,235,0.6); }
        .ghost-btn { display: inline-block; background: transparent; color: #aaa; padding: 14px 32px; border-radius: 10px; font-size: 16px; font-weight: 500; text-decoration: none; cursor: pointer; border: 1px solid #222; transition: all 0.2s; font-family: inherit; }
        .ghost-btn:hover { border-color: #444; color: white; }
        .feature-card { background: #0d1117; border: 1px solid #1a2030; border-radius: 20px; padding: 32px; transition: border-color 0.2s, transform 0.2s; position: relative; overflow: hidden; }
        .feature-card:hover { border-color: #2563eb; transform: translateY(-4px); }
        .feature-card::before { content: ''; position: absolute; top: 0; left: 0; right: 0; height: 1px; background: linear-gradient(90deg, transparent, #2563eb, transparent); opacity: 0; transition: opacity 0.2s; }
        .feature-card:hover::before { opacity: 1; }
        .review-card { background: #0a0e1a; border: 1px solid #1a2030; border-radius: 16px; padding: 20px; margin-bottom: 12px; }
        .badge { display: inline-flex; align-items: center; gap: 6px; background: rgba(37,99,235,0.1); border: 1px solid rgba(37,99,235,0.3); color: #60a5fa; padding: 6px 14px; border-radius: 100px; font-size: 13px; font-weight: 500; }
        .pricing-card { background: #0d1117; border: 1px solid #1e3a5f; border-radius: 24px; padding: 48px; position: relative; overflow: hidden; max-width: 440px; width: 100%; box-shadow: 0 0 80px rgba(37,99,235,0.15); margin: 0 auto; }
      ...
      <section style={{ paddingTop: 160, paddingBottom: 120, textAlign: 'center', padding: '160px 5% 120px', position: 'relative' }}>
        <div className="glow" style={{ width: 600, height: 600, background: '#1d4ed8', top: -200, left: '50%', transform: 'translateX(-50%)', opacity: 0.12 }} />
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 820, margin: '0 auto' }}>
          ...
          <div className="hero-btns" style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 48 }}>
            <a href="/collect/testbiz" className="cta-btn" style={{ fontSize: 17, padding: '16px 40px' }}>See it in action →</a>
            <a href="#how" className="ghost-btn" style={{ fontSize: 17, padding: '16px 40px' }}>How it works</a>
          </div>
        ...
        <div style={{ maxWidth: 700, margin: '0 auto' }}>
          <div style={{ background: '#0d1117', border: '1px solid #1a2030', borderRadius: 24, padding: 32, boxShadow: '0 0 80px rgba(37,99,235,0.1)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 24 }}>
              ...
              <span style={{ color: '#555', fontSize: 13, marginLeft: 8 }}>trustdrop-lac.vercel.app/widget/your-business</span>
            </div>
      ...
      <section id="features" style={{ padding: '80px 5% 120px', position: 'relative' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', marginBottom: 64 }}>
            ...
            <h2 style={{ fontSize: 44, fontWeight: 800, letterSpacing: '-1px', marginBottom: 16 }}>Everything you need to<br />build social proof</h2>
          ...
          <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20 }}>
            {[
              ...
              { icon: '📊', title: 'Analytics dashboard', desc: 'Track how many reviews you collect, your average rating, and which products get the most praise.' },
            ].map((f, i) => (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            {[
              ...
              <div key={i} style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
                <div style={{ width: 44, height: 44, minWidth: 44, background: 'rgba(37,99,235,0.15)', border: '1px solid rgba(37,99,235,0.4)', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#60a5fa', fontWeight: 700, fontSize: 13 }}>
                  {s.step}
                </div>
      ...
      <section id="pricing" style={{ padding: '80px 5% 120px', position: 'relative' }}>
        <div className="glow" style={{ width: 600, height: 600, background: '#1d4ed8', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', opacity: 0.08 }} />
        <div style={{ maxWidth: 500, margin: '0 auto', textAlign: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <div className="pricing-card">
            ...
            <div style={{ position: 'relative' }}>
              <div style={{ background: 'rgba(37,99,235,0.2)', border: '1px solid rgba(37,99,235,0.4)', display: 'inline-block', padding: '4px 14px', borderRadius: 100, fontSize: 12, fontWeight: 600, color: '#60a5fa', marginBottom: 28 }}>✦ MOST POPULAR</div>
              ...
              {['Unlimited review collection', 'Beautiful embeddable widget', 'Review approval dashboard', 'AI-powered insights', 'Custom collection page', 'Email notifications', 'Cancel anytime'].map((f, i) => (
      ...
      <section style={{ padding: '80px 5% 120px', textAlign: 'center', position: 'relative' }}>
        <div className="glow" style={{ width: 500, height: 500, background: '#1d4ed8', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', opacity: 0.1 }} />
      ...
      {/* FOOTER */}
      <footer style={{ borderTop: '1px solid #111', padding: '40px 5%' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 24, marginBottom: 32 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              <div style={{ width: 28, height: 28, background: 'linear-gradient(135deg, #2563eb, #1d4ed8)', borderRadius: 7, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 14 }}>⭐</div>
              <span style={{ fontWeight: 700, fontSize: 16 }}>TrustDrop</span>
            </div>
            <div style={{ display: 'flex', gap: 24 }}>
              <a href="#" style={{ color: '#444', fontSize: 14, textDecoration: 'none' }}>Privacy</a>
              <a href="#" style={{ color: '#444', fontSize: 14, textDecoration: 'none' }}>Terms</a>
              <a href="/dashboard" style={{ color: '#444', fontSize: 14, textDecoration: 'none' }}>Dashboard</a>
            </div>
          </div>

          {/* FOUNDER SECTION */}
          <div style={{ borderTop: '1px solid #111', paddingTop: 32, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              <div style={{ width: 44, height: 44, background: 'linear-gradient(135deg, #2563eb, #1d4ed8)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 800, fontSize: 16, boxShadow: '0 0 20px rgba(37,99,235,0.3)' }}>
                A
              </div>
              <div>
                <p style={{ fontWeight: 700, fontSize: 15, color: 'white' }}>Abrham Tekuam</p>
                <p style={{ color: '#555', fontSize: 13 }}>SaaS Founder · Built from Ethiopia 🇪🇹</p>
              </div>
            </div>
            <p style={{ color: '#333', fontSize: 13 }}>© 2026 TrustDrop · All rights reserved</p>
          </div>
